...
<!-- kết thúc menu -->
 ...
 <!-- giới thiệu -->
  <div class="container" >
    <div class="alert ">
       <h4>Tổng hợp và giới thiệu các loại <a href="{{ route('home') }}" class="alert-link">đồ điện tử </a> máy tính để bàn</h4> 
       Đây sẽ là bài viết giải thích những đồ điện tử quan trọng cần có.
      </div>
           ...
           <div class="card card-deck p-3" style="width:300px">
               ...
               <div class="mb-2">
                 <h6 class="card-title">Bộ nguồn (PSU) là một linh kiện phần cứng quan trọng, cung cấp điện năng hoạt động cho toàn bộ PC. Một bộ nguồn tiêu chuẩn còn có thể quyết định được sự ổn định của hệ thống, cũng như tuổi thọ của các thiết bị phần cứng khác.
                    ...
                    Tham khảo thêm các linh đồ điện tử khác: Case máy tính, tản nhiệt để build PC.</h6>
